    ...
    <footer className="footer">
      ...
      <div className="footer-container">
        ...
        <div className="footer-brand">
          <div className="footer-logo-wrap">
            <h3 className="footer-logo">Gym<em>Bites</em></h3>
            <span className="footer-logo-sub">Cloud Kitchen · Hyderabad</span>
          </div>

          <p className="footer-tagline">
            We cook, you lift. Premium meal prep designed for athletes,
            bodybuilders, and fitness enthusiasts who take their diet seriously.
          </p>
          ...
          <div className="footer-socials">
            ...
            <a className="footer-social" href="#" aria-label="WhatsApp">
              <svg width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="footer-col">
            ...
            <ul>
              <li className="contact-info">
                <span className="contact-icon">📍</span>Hyderabad, India
              </li>
              <li className="contact-info">
                <span className="contact-icon">📧</span>support@gymbites.in
              </li>
              <li className="contact-info">
            ...
            {/* Mini CTA */}
            <a href="#" className="footer-order-btn">Order Now →</a>
          </div>
        </div>
      ...
      <div className="footer-bottom">
        <p className="footer-copy">
          © {year} GymBites. All rights reserved.
        </p>
        <p className="footer-made">
          Clean fuel. ⚡ Real gains.
        </p>
      </div>
